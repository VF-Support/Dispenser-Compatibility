const BASE_57_01_00_DATA = { 
  version: "Base 57.01.00",
  ...
  brands: {
    ...
    "Gilbarco": {
      generalNote: "See https://www.vfne.co/verifone-petro-emv-updates for Outdoor EMV Implementation Status updates. When connecting the Verifone Commander Ethernet cable to a DCR Serial Converter for Outdoor EMV, the wires routed from the converter to the DCR must be twisted pair.",
      ...
      platforms: {
        "FlexPay IV (M7)": {
          ...
          supportedOptions: [
            ...
            { option: "Fleet 2.0 Version (PCI DSS 5.0)", minimumVersion: "FPIVOPT_V05.14.04_US00.07" },
            { option: "Fleet 2.0 Version (PCI DSS 4.0)", minimumVersion: "FPIVOPT_V04.14.04_US00.07" },
          ...
          distributionSpecificSupportedFleetVersions: {
             title: "Distribution Specific Supported Fleet Versions",
             headers: ["Distribution", "Fleet Version"],
             rows: [
               { distribution: "Chevron", version: "6.8.2.25-x VIPA" },
               { distribution: "VerifoneEPS", version: "FPIVOPT_V05.14.04_US00.07 / FPIVOPT_V04.14.04_US00.07" }
             ]
          },
          debit: [
          ...
          notes: [
            "WARNING: FlexPay 4 sites must upgrade firmware to the versions listed above before installing 57.01.00 or DCRs will stop communicating.",
