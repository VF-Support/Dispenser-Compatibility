const BASE_53_41_03_TO_53_41_04_DATA = {
  version: "Base 53.41.03 to 53.41.04",
  brands: {
    "Bennett": {
      ...
      platforms: {
        ...
        "DCT (Verifone Everest Card Reader)": {
          debit: [
            { option: "Horizon 1", minimumVersion: "v6.27" },
            { option: "Horizon 2", minimumVersion: "v2.15" },
            { option: "Pacific", minimumVersion: "v2.11" },
    ...
    "Invenco": {
      generalNote: 'Invenco / GVR DCR products have been rebranded as FlexPay 6. FlexPay 6 is not supported in all applications.<br>See <a href="https://www.vfne.co/verifone-petro-emv-updates" target="_blank">https://www.vfne.co/verifone-petro-emv-updates</a> for Outdoor EMV Implementation Status updates.',
      platforms: {
        "FlexPay 6 All-In-One 9\" A2-09 (G6-400)": {
          emvCertification: {
            contact: "Certified",
            contactless: "Certified"
          },
        ...
        "FlexPay 6 All-In-One 5\" A1-05 (G6-300)": {
          emvCertification: {
            contact: "Certified",
            contactless: "Certified"
          },
        ...
        "FlexPay 6 Modular 15\" M1-15 (G7-100)": {
          emvCertification: {
            contact: "Certified",
            contactless: "Certified"
          },
    ...
    "Wayne": {
      generalNote: 'See <a href="https://www.vfne.co/verifone-petro-emv-updates" target="_blank">https://www.vfne.co/verifone-petro-emv-updates</a> for Outdoor EMV Implementation Status updates.<br>When connecting the Commander Ethernet cable to a DCR Serial Converter for Outdoor EMV, the wires routed from the converter to the DCR must be twisted pair.',
      dispenserSoftware: [
        { dispenser: "Ovation", description: "iGem", version: "49", modelMatch: ["Ovation and Ovation 2 with qCAT"] },
        { dispenser: "iX", description: "iGem", version: "49", modelMatch: ["iX Pay 2, 3.1 Series", "iX Pay 1, 2.8 Series", "iX — Blue Board"] },
