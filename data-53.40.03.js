  ...
  notes: [
    ...
    "Please contact your Gilbarco servicer for the correct setup of the EPP and the mapping of the keypad."
        ...
        "Advantage CRIND (Z180 Logic Board)": {
          supportedOptions: [
            // CHANGED: versions reverted from 60.9.40 to 609.40
          ...
          debit: [
            ...
            // CHANGED: SDES (DUKPT) reverted to TDES
    ...
    "Invenco": {
      // CHANGED: removed FlexPay 6 rebranding note (not present in 53.40.03)
      generalNote: 'See <a href="https://www.vfne.co/verifone-petro-emv-updates" target="_blank">https://www.vfne.co/verifone-petro-emv-updates</a> for Outdoor EMV Implementation Status updates.',
      platforms: {
        // CHANGED: 54.01.00's three FlexPay 6 named models collapsed back into
        // the single combined 53.40.03 entry "G6 300 and G7 100 OPT"
        "G6 300 and G7 100 OPT": {
          emvCertification: {
            contact: "Certified",
            contactless: "Certified"
          },
      ...
      platforms: {
        "Premier B": {
          ...
          debit: [
            ...
            // CHANGED: label reverted from "Debit TDS Plus (4-line display) SDES (DUKPT)" to plain "SDES (DUKPT)"
    ...
    "Wayne": {
      ...
      platforms: {
        ...
        // REMOVED: "Anthem (AX12, AX27)" — this variant does not exist in 53.40.03
        "iX — Blue Board": {
          supportedOptions: [
        ...
        "Legacy CAT": {
          ...
          debit: [
            ...
            // CHANGED: SDES (DUKPT) 64.00 reverted to TDES 54.00
