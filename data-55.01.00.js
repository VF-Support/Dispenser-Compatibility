// data-55.01.00.js
const BASE_55_01_00_DATA = {
  version: "Base 55.01.00",
  generalNote: "In 55.00.01, Shell support for Invenco dispensers was classified as Beta (No). This was upgraded to fully supported (Yes) in version 55.01.00.",
  brands: {
    "Bennett": {
      ...
      platforms: {
        "SSP (Simply Secure Payment)": {
          emvCertification: { contact: "Certified", contactless: "Certified" },
      ...
      platforms: {
        "FlexPay 6 Outdoor Payment Terminals": {
          ...
          notes: [
            ...
            "Full support (Yes) for Invenco dispensers on Shell was introduced in version 55.01.00."
          ]
        }
      }
    },
...
module.exports = BASE_55_01_00_DATA;
